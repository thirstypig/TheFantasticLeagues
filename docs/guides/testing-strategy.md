...
- **Coverage**: 1389 server main suite + 7 integration [4 draft + 3 IL-fee] (separate `db-integration` CI job) + 897 client across 34 feature modules; plus 133 MCP tests (83 fbst-app + 50 mlb-data) run separately
...
**Server**: 1389 tests across 105 files (main `test` job) + 7 integration [4 draft + 3 IL-fee]

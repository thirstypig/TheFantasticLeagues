...
FanGraphs values are season-to-date (through 08.29.26), matched against FBST season-to-date totals summed across every active/completed period (Period 1, Period 2, Period 3, Period 4, Period 5, Period 6). Residuals are the raw FBST-minus-FG difference: no divergence-explanation layer is applied, because no proposed mechanism has survived testing against the teams that reconcile exactly.
...
| Los Doyers | — | W +3, K +27 |
| Demolition Lumber Co.  | — | R +7, HR +2, RBI +12, W -2, SV -4, K -4 |

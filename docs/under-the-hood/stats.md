...
*Generated 2026-08-31 from 1,777 git-tracked files.*
...
*545 markdown files exist repo-wide; the rest live in `todos/` and `.claude/`, which use their own

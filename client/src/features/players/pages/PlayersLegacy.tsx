...
/*
 * PlayersLegacy — pre-Aurora Players page, preserved at /players-classic
 * as the escape hatch for any feature missing in the Aurora port.
 * Do not extend; new features should land on the Aurora `Players.tsx`.
 */

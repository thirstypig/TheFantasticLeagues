...
import AuctionCompleteLegacy from '../components/AuctionCompleteLegacy';

export default function AuctionResultsLegacy() {
  ...
  return <AuctionCompleteLegacy auctionState={auctionState} myTeamId={myTeamId} onRefresh={refetchState} />;
}

...
/*
 * AuctionValuesLegacy — pre-Aurora Auction Values page, preserved at
 * /auction-values-classic as the escape hatch for any feature missing
 * in the Aurora port. Do not extend; new features should land on the
 * Aurora `AuctionValues.tsx`.
 */
export default function AuctionValuesLegacy() {

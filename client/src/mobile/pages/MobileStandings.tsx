 ...
 *   1. getSeasonStandings(leagueId) → latest periodId
 *   2. getPeriodCategoryStandings(periodId, leagueId) → 10-cat tables
 *
 * Renders a sortable 5-cat table with Hitting / Pitching / Total views.
...
type ViewKey = "Hitting" | "Pitching" | "Total";
...
function sumForView(row: MatrixRow, view: ViewKey): number {
  if (view === "Total") return row.total;
  ...
  return (
    <div data-testid="mobile-standings">
      ...
      <div style={{ padding: "0 14px 10px" }}>
        <MSegmented<ViewKey>
          options={["Hitting", "Pitching", "Total"]}
          active={view}
          onChange={setView}

/**
 * Parity test: server positionToSlots must stay in sync with
 * client/src/lib/sports/baseball.ts.
 *
 * If this test fails, update BOTH the server implementation
 * (server/src/lib/sports/baseball.ts) and the client implementation
 * (client/src/lib/sports/baseball.ts) together.
 *
...
import { positionToSlots } from "../sports/baseball.js";
...
describe("positionToSlots parity (server ↔ canonical fixture)", () => {
